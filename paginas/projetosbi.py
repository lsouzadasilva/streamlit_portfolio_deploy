...
def bi():
    ...
    with col1:
        st.image(image_path_fic, caption="Projeto 1", width=200)
    ...
    with col2:
        st.image(image_path_fic, caption="Projeto 2", width=200)
        st.link_button("Acesse",
    ...
    with col3:
        st.image(image_path_fic, caption="Projeto 3", width=200)
        st.link_button("Acesse",
    ...
    with col4:
        st.image(image_path_fic, caption="Projeto 4", width=200)
        st.link_button("Acesse",
    ...
    with col5:
        st.image(image_path_fic, caption="Projeto 5", width=200)
        st.link_button("Acesse",
    ...
    with col6:
        st.image(image_path_fic, caption="Projeto 6", width=200)
        st.link_button("Acesse",
    ...
    with col7:
        st.image(image_path_fic, caption="Projeto 7", width=200)
        st.link_button("Acesse",
    ...
    with col8:
        st.image(image_path_fic, caption="Projeto 8", width=200)
        st.link_button("Acesse",
    ...
    with col9:
        st.image(image_path_fic, caption="Projeto 9", width=200)
        st.link_button("Acesse",
    ...
    with col10:
        st.image(image_path_fic, caption="Projeto 10", width=200)
        st.link_button("Acesse",
